...
users.forEach(email => insertUser.run(email, passwordHash));
...
managers.forEach(m => insertManager.run(m.name, m.company, m.department, m.title));
...
const reviews = [
  // Sarah Chen - Great manager (Manager ID: 1)
  ...
  // Michael Rodriguez - Mixed reviews (Manager ID: 2)
  ...
  // Emily Watson - Good manager (Manager ID: 3)
  ...
  // David Kim - Startup intensity (Manager ID: 4)
  ...
  // Jessica Martinez - Good operator (Manager ID: 5)
  ...
  // Robert Johnson - Corporate politics (Manager ID: 6)
  ...
  // Amanda Foster - Solid but demanding (Manager ID: 7)
  ...
  // Dr. James Wilson - Academic style (Manager ID: 8)
  ...
  // Lisa Thompson - IT Manager (Manager ID: 9)
  ...
  // Chris Anderson - Creative Director (Manager ID: 10)
  ...
  // Additional reviews to reach 30+
...
insertVerification.run(1, 1, 'john.doe@techcorp.com', '123456', '2022-01-15', '2024-03-01');
insertVerification.run(2, 1, 'jane.smith@techcorp.com', '234567', '2021-06-01', '2023-12-15');
insertVerification.run(1, 2, 'john.doe@techcorp.com', '345678', '2022-01-15', '2024-03-01');
